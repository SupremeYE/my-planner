                  ...
                  {FLOW_OPTIONS.map(opt => (
                    <button key={opt.key} onClick={() => setFlowLevel(flowLevel === opt.key ? null : opt.key)}
                      ...
                      style={{
                        ...
                        backgroundColor: flowLevel === opt.key ? PERIOD_COLOR : t.surfaceMuted,
                  ...
                  {SYMPTOM_OPTIONS.map(s => (
                    <button key={s} onClick={() => toggleSymptom(s)}
                      ...
                      style={{
                        ...
                        backgroundColor: symptoms.includes(s) ? PERIOD_COLOR + '25' : t.surfaceMuted,
  ...
  const renderTimeSlot = (
    ...
    return (
      <div
        ...
        style={{
          backgroundColor: isEmpty ? t.surfaceMuted : SLEEP_COLOR + '12',
      ...
      <div ref={formRef} className="p-3 lg:p-4 rounded-2xl mb-3" style={solidCardStyle(t)}>
        ...
        <div className="mb-3">
          <input
            ...
            style={{ borderColor: t.borderLight, backgroundColor: inputBg(t), color: t.text, fontSize: 13, WebkitAppearance: 'none', appearance: 'none', boxSizing: 'border-box', minWidth: 0 }}
          />
          ...
          <div>
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <button onClick={toggleSearch} aria-label="검색" aria-pressed={searchOpen}
                ...
                style={{
                  backgroundColor: searchOpen ? `${SLEEP_COLOR}1A` : t.surfaceMuted,
            ...
            {searchOpen ? (
              ...
              <div className="flex items-center gap-2 mb-3 px-3 py-2 rounded-xl"
                style={{ backgroundColor: inputBg(t), border: `1px solid ${t.borderLight}` }}>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center" style={{ backgroundColor: 'rgba(0,0,0,0.4)' }}>
      <div className="rounded-2xl shadow-xl w-[400px]" style={{ backgroundColor: t.card, border: `1px solid ${t.border}` }}>
            ...
            <div className="flex gap-2 mt-1.5">
              {CATEGORIES.map(cat => (
                <button key={cat.key} onClick={() => setCategory(cat.key)}
                  ...
                  style={{
                    fontSize: 12, backgroundColor: category === cat.key ? cat.color : t.surfaceMuted,
        ...
        <div className="flex gap-2 px-5 py-4 border-t" style={{ borderColor: t.border }}>
          <button onClick={onClose} className="flex-1 py-2 rounded-xl" style={{ fontSize: 13, color: t.textSub, backgroundColor: t.surfaceMuted }}>취소</button>
      ...
      {daily.map(d => {
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 flex rounded-full overflow-hidden" style={{ height: 14, backgroundColor: t.surfaceMuted }}>
      ...
      {byCategory.map(c => {
        ...
        return (
          <div key={c.tagId}>
            ...
            <div className="rounded-full overflow-hidden" style={{ height: 6, backgroundColor: t.surfaceMuted }}>
...
function ExpandedCategoryTodos({ byCategory }: { byCategory: ReturnType<typeof useTimeReport>['byCategory'] }) {
  ...
  if (byCategory.length === 0) {
    return (
      <div className="py-8 text-center rounded-2xl" style={{ backgroundColor: t.surfaceMuted, fontSize: 13, color: t.textMuted }}>
        표시할 활동이 없어요
      </div>
    );
  }
...
function PeriodTabs({ period, onChange }: { period: TimeReportPeriod; onChange: (p: TimeReportPeriod) => void }) {
  const { t } = useTheme();
  return (
    <div className="flex p-1 rounded-xl" style={{ backgroundColor: t.surfaceMuted }}>
