...
function ScrapCard({
  ...
  return (
    ...
    >
      ...
      {/* 썸네일 영역 */}
      {hasImage ? (
        <div style={{ position: 'relative', backgroundColor: t.surfaceMuted }}>
          <img
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: '5px 10px',
                borderRadius: 999,
                backgroundColor: canShuffle ? t.accentLight : t.surfaceMuted,
                border: 'none',
                display: 'inline-flex',
                alignItems: 'center',
                gap: 4,
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                padding: '8px 16px',
                borderRadius: 999,
                backgroundColor: selectedIds.size === 0 ? t.surfaceMuted : t.danger,
