          ...
          <div className="flex gap-3">
              ...
              <div className="flex flex-wrap gap-1.5 w-36 lg:w-40">
                {EMOJI_PALETTE.map(e => (
                  <button key={e} onClick={() => setIcon(e)}
                    ...
                    style={{
                      backgroundColor: icon === e ? t.accent + '22' : t.lavenderTint,
            ...
            <div className="flex-1">
              ...
              <input
                ...
                style={{ borderColor: t.border, fontSize: 14, backgroundColor: t.lavenderTint, color: t.text }}
              />
              <div className="mt-3">
          ...
          {showSummary ? (
            <div className="px-5 py-6 lg:px-6 space-y-5">
              ...
              <button onClick={handleComplete}
                ...
                style={{
                  backgroundColor: isCompletedToday ? t.lavenderTint : '#006b62',
              ...
              <button onClick={handleReset}
                ...
                style={{ backgroundColor: t.lavenderTint, color: t.textSub, fontSize: 13 }}>
                ...
                <div className="rounded-xl overflow-hidden"
                  ...
                  <div className="px-4 py-4 space-y-4" style={{ backgroundColor: t.card }}>
                    ...
                    <div className="flex flex-col items-center gap-2">
                      ...
                      {/* 진행 바 */}
                      <div className="w-full h-2 rounded-full overflow-hidden" style={{ backgroundColor: t.lavenderTint }}>
                        {stepRemaining >= 0 ? (
                    ...
                    {!started ? (
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => setRunning(r => !r)}
                          ...
                          style={{
                            flex: 1,
                            backgroundColor: running ? t.lavenderTint : t.lavenderTint,
                  ...
                  {routineSteps.map((step, i) => {
                    ...
                    return (
                      <div key={i}
                        ...
                        style={{
                          backgroundColor: isCurrent ? t.accent + '12' : isDone ? t.lavenderTint : t.lavenderTint,
    ...
    <div className="rounded-2xl p-4 flex items-center gap-4 transition-all"
      ...
      <div className="relative flex-shrink-0">
        <div className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl"
          style={{ backgroundColor: isCompletedToday ? t.accent + '20' : t.lavenderTint }}>
          {routine.icon}
        </div>
        {isCompletedToday && (
      ...
      <div className="flex items-center gap-2 flex-shrink-0">
        <button onClick={onEdit} className="p-2 rounded-lg" style={{ color: t.textMuted, backgroundColor: t.lavenderTint }}>
          <Edit3 size={14} />
        </button>
        <button onClick={onRun}
          ...
          style={{
            fontSize: 12, fontWeight: 600,
            backgroundColor: isCompletedToday ? t.lavenderTint : t.accent,
            color: isCompletedToday ? t.textMuted : '#fff',
          }}>
