...
// 카테고리명 → 차트 색(지출 11 + 수입 4). 프리셋 식별용 고정값.
// 주의(색 충돌 — 사용자 지정값 그대로): 문화=구독(#8B7EC8), 쇼핑=주거(#E8A84C).
export const CATEGORY_COLORS: Record<string, string> = {
  // 지출
  식비: '#D4735A', 생필품: '#C4A882', 교통: '#6BAA7A', 카페: '#7A7265',
  쇼핑: '#E8A84C', 문화: '#8B7EC8', 건강: '#5B9BD5', 통신: '#B8AD9E',
  구독: '#8B7EC8', 보험: '#7BA8B8', 주거: '#E8A84C',
  // 수입
  급여: '#6BAA7A', 부수입: '#8B7EC8', '용돈/선물': '#E8A84C', 투자수익: '#5B9BD5',
};
